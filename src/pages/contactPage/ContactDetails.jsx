...
const ContactDetails = () => {
    return (
        <div className='bg-white py-[30px] xl:py-[100px]'>
            <Container>
                <div className='font-mont space-y-2 xl:space-y-4 text-center'>
                    <h3 className='text-[#1A124D] text-xl xl:text-2xl font-bold'>Our Branches</h3>
                    <h2 className='text-[#1c0d0a] text-[30px] xl:text-[40px] font-bold'>Contact Details</h2>
                </div>
                <div className='py-[20px] xl:py-[50px] flex flex-col lg:flex-row '>
                    <div className='w-full xl:w-[30%] space-y-2 xl:space-y-5 p-5'>
                        ...
                        <div className='space-y-2 py-2 xl:py-5'>
                    ...
                    <div className='w-full xl:w-[70%] '>
                        <iframe
                            className="w-full h-full min-h-[475px] border-0"
