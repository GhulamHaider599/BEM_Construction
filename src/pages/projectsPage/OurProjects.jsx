    ...
    return (
        <div className='bg-white'>
            <Container className='pt-[100px] pb-[50px] text-center font-mont space-y-4'>
                <h3 className='text-[#1A124D] text-2xl font-bold'>Our Projects</h3>
                <h2 className='text-[#242424] text-[40px] font-bold'>Latest Works</h2>
            </Container>
            <div className='grid grid-cols-4'>
                {projects.map((item, index) => (
                    <div key={index} className='group bg-cover bg-center min-h-[453px] relative text-white overflow-hidden' style={{ backgroundImage: `url(${item.img})` }}>
