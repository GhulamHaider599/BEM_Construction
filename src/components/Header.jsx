...
import { ChevronDown, ChevronRight, Facebook, Instagram, Linkedin, MenuIcon, Twitter, X } from 'lucide-react'
...
const Header = () => {
  ...
  return (
    <div className='w-full absolute z-30'>
      ...
      <hr className="border-[rgba(235,235,235,0.24)] hidden lg:block" />
      {/* <Container className='hidden lg:flex justify-between items-center py-6'>
        <div>
          <nav>
            <ul className='flex gap-x-5 text-white'>
              {navItems.map((navItem, index) => {
